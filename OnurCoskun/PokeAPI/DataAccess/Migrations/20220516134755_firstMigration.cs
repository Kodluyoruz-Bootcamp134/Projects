    ...
    public partial class firstMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PokemonClasses", x => new { x.PokemonId, x.ClassId });
                    table.ForeignKey(
                        name: "FK_PokemonClasses_Classes_ClassId",
                        column: x => x.ClassId,
                        principalTable: "Classes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PokemonClasses_Pokemon_PokemonId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PokemonClasses_ClassId",
                table: "PokemonClasses",
                column: "ClassId");
