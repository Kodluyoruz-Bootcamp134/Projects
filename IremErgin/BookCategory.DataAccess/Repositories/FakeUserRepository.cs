    ...
    public class FakeUserRepository : IUserRepository
    {
        ...
        public FakeUserRepository()
        {
            _users = new List<User>()
            {
                ...
                new User(){Id = 2, FirstName = "Mary", Email = "a@test.com", Role = "Editor", Password = "123", UserName = "user2"},
                new User(){Id = 3, FirstName = "Billy", Email = "a@test.com", Role = "Client", Password = "123", UserName = "user3"}
            };
        }
